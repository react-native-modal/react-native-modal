...
declare const _default: React.ForwardRefExoticComponent<import("react-native").ViewProps & {
    animationIn?: import("react-native-animatable").Animation | import("react-native-animatable").CustomAnimation<import("react-native").TextStyle & import("react-native").ViewStyle & import("react-native").ImageStyle> | undefined;
    animationOut?: import("react-native-animatable").Animation | import("react-native-animatable").CustomAnimation<import("react-native").TextStyle & import("react-native").ViewStyle & import("react-native").ImageStyle> | undefined;
    ...
    propagateSwipe?: boolean | ((event: import("./types").GestureResponderEvent, gestureState: import("react-native").PanResponderGestureState) => boolean) | undefined;
    ...
    onSwipeStart?: ((gestureState: import("react-native").PanResponderGestureState) => void) | undefined;
    onSwipeMove?: ((percentageShown: number, gestureState: import("react-native").PanResponderGestureState) => void) | undefined;
    onSwipeComplete?: ((params: import("./types").OnSwipeCompleteParams, gestureState: import("react-native").PanResponderGestureState) => void) | undefined;
    onSwipeCancel?: ((gestureState: import("react-native").PanResponderGestureState) => void) | undefined;
    style?: import("react-native").StyleProp<import("react-native").ViewStyle>;
    swipeDirection?: import("./types").Direction | import("./types").Direction[] | undefined;
