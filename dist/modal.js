...
export class ReactNativeModal extends React.Component {
    ...
    render() {
        ...
        const containerView = (React.createElement(animatable.View, { ...panHandlers, ref: (ref) => (this.contentRef = ref), style: [panPosition, computedStyle], pointerEvents: "box-none", useNativeDriver: useNativeDriver, ...containerProps }, _children));
