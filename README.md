...
| containerWidth                 | number           | null                      | Content container width, if not set defaults to deviceWidth and deviceWidth*0.5 margin. If bigger than deviceWidth will use deviceWidth    |
